...
<template>
    <div class="auth-screen">
        <div class="auth-card">
            ...
            <div class="auth-view">
                <h2>Recuperar nome de utilizador</h2>
                <p class="sub">Indique o email da sua conta e enviaremos o seu nome de utilizador.</p>
                ...
                <form @submit.prevent="submit">
                    ...
                    <button type="submit" class="btn btn-primary" :disabled="form.processing">Enviar nome de utilizador</button>
                </form>
